...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MessageResponse> handleResponseStatus(ResponseStatusException exception) {
        String message = exception.getReason() != null ? exception.getReason() : "Requête impossible.";
    ...
    public ResponseEntity<MessageResponse> handleDataIntegrity() {
        return ResponseEntity.badRequest()
                .body(new MessageResponse("Impossible d'enregistrer ces données. Vérifie que l'email n'existe pas déjà."));
    }
